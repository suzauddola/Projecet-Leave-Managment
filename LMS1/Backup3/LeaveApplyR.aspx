<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPageR.Master" CodeBehind="LeaveApplyR.aspx.cs" Inherits="LMS1.LeaveApplyR" %>
	        ...
	        <td>
	            ...
	            <tr>
		            ...
		            <td valign="top">
		                ...
		                <asp:Button ID="SubmitR" runat="server" CssClass="form-submit" Text="Submit" />
                        <asp:Button ID="ResetR" runat="server" CssClass="form-reset" Text="Reset" />
		        ...
		        <div id="related-act-bottom">
			        ...
			        <div id="related-act-inner">
				        ...
				        <div class="right">
					        ...
					        <ul class="greyarrow">
						        <li><a href="LeaveStatusR.aspx">Click Here</a></li> 
						    </ul>
				        </div>
				        ...
				        <div class="right">
					        ...
					        <ul class="greyarrow">
						        <li><a href="LeaveHistoryR.aspx">Click Here</a></li> 
						    </ul>
				        </div>
				        ...
				        <div class="right">
					        <h5>Recommend List</h5>
					        Requested Leaves-
					        <ul class="greyarrow">
						        <li><a href="RecommendListR.aspx">Click Here</a></li> 
						    </ul>
				        </div>
				        <div class="clear"></div>
